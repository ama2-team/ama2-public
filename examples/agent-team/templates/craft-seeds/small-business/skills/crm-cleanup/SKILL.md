...
If HubSpot is unreachable, stop — this command requires HubSpot as the data source. Tell the owner: "HubSpot isn't connected. Connect it in Claude Code settings, then rerun /crm-cleanup."
