...
Either let the native Claude Code carousel render the tool result automatically,
...
single grouped batch triggers Claude Code's side-by-side carousel, which
renders correctly.
